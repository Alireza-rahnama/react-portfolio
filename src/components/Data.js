...
const data = [
    ...
    {source: javaarcade,
    desc: "Developed an ecommerce application using Designed and implemented 2 Java GUI games:  King Domino & Mind the Gap. Hover over image to checkout the github repo.",
    git_url: "https://github.com/Alireza-rahnama/Java-Arcade-OOP-Java-Codes-"},
    {source: histogram,
    desc: "Implemented a set of image processing techniques including Histogram, Aggressive Stretch and Equalizer. Hover over image to checkout the github repo.",
    git_url: "https://github.com/Alireza-rahnama/image-processing-core-java/tree/main/histogram_gui"},
    {source: threshold,
    desc: "Implemented thresholding image processing technique to extract the area of interest in an input image. Hover over image to see demo or github repo. Hover over image to checkout the github repo.",
